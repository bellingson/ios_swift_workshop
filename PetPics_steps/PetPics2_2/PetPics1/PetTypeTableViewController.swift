...
class PetTypeTableViewController: UITableViewController {
    ...
    let petTypes = [ "Cats", "Dogs", "Fish", "Birds" ]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("petTypeCell", forIndexPath: indexPath)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "petPics" {
            ...
            let ctrl = segue.destinationViewController as! PetCollectionViewController
            ctrl.petType = petTypes[indexPath.row]
